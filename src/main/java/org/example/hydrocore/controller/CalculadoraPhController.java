...
@Tag(name = "Calculadora pH Controller", description = "Cálculo de ph baseado na etapa da água")
public interface CalculadoraPhController {
    ...
    ResponseEntity<CalculoResponseDTO> calcularPhFloculacao(@RequestBody CalculoRequestDTO calculoRequestDTO);
    ...
    ResponseEntity<CalculoResponseDTO> calcularPhCoagulacao(@RequestBody CalculoRequestDTO calculoRequestDTO);
